...
## gapminder - trends in world health and economics
data("gapminder")
head(gapminder)
names(gapminder)
...
# faceting - stratify(split) by column
...
# histograms of income in West vs developing world
...
# income distribution: West vs rest, with available data
...
# boxplot of income - West vs rest, 1970 vs 2010
p <- gapminder %>%
